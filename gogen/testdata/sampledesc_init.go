...
func GetModel1(p1 string, p2 []int32, p3 string) (*Model1, error) {
	var (
		b []byte
	)

	q := qpGetModel1ById.Get().(*gocqlx.Queryx)
	defer qpGetModel1ById.Put(q)
...
func GetModel1ByP3(p3 string, p1 string, p2 []int32) (*Model1, error) {
	var (
		b []byte
	)
...
func GetModel2(pQ1 int64) (*Model2, error) {
	...
	q := qpGetModel2ByPQ1.Get().(*gocqlx.Queryx)
	defer qpGetModel2ByPQ1.Put(q)
