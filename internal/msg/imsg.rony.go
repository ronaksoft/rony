...
func unwrapGetPage(e registry.Envelope) (proto.Message, error) {
	x := &GetPage{}
...
func unwrapTunnelMessage(e registry.Envelope) (proto.Message, error) {
	x := &TunnelMessage{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEdgeNode(e registry.Envelope) (proto.Message, error) {
	x := &EdgeNode{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapPage(e registry.Envelope) (proto.Message, error) {
	x := &Page{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func init() {
	registry.Register(3661906127733581696, "GetPage", unwrapGetPage)
	registry.Register(12904103981552626014, "TunnelMessage", unwrapTunnelMessage)
	registry.Register(12741646567456486228, "EdgeNode", unwrapEdgeNode)
	registry.Register(3661906127056011264, "Page", unwrapPage)
...
func NewPageLocalRepo(s *store.Store) *PageLocalRepo {
