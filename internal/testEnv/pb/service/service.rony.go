...
func unwrapGetRequest(e registry.Envelope) (registry.Message, error) {
	x := &GetRequest{}
...
func unwrapGetResponse(e registry.Envelope) (registry.Message, error) {
	x := &GetResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapSetRequest(e registry.Envelope) (registry.Message, error) {
	x := &SetRequest{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapSetResponse(e registry.Envelope) (registry.Message, error) {
	x := &SetResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEchoRequest(e registry.Envelope) (registry.Message, error) {
	x := &EchoRequest{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEchoResponse(e registry.Envelope) (registry.Message, error) {
	x := &EchoResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapMessage1(e registry.Envelope) (registry.Message, error) {
	x := &Message1{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapMessage2(e registry.Envelope) (registry.Message, error) {
	x := &Message2{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func init() {
	...
	registry.Register(10382375233116730107, "GetResponse", unwrapGetResponse)
	registry.Register(8181913290764647384, "SetRequest", unwrapSetRequest)
	registry.Register(10382356249361281787, "SetResponse", unwrapSetResponse)
	registry.Register(634453994073422796, "EchoRequest", unwrapEchoRequest)
	registry.Register(10208763112635265787, "EchoResponse", unwrapEchoResponse)
	registry.Register(1806736971761742569, "Message1", unwrapMessage1)
	registry.Register(2000391755738673897, "Message2", unwrapMessage2)
	registry.Register(5610266072904040111, "SampleEcho", unwrapEchoRequest)
	registry.Register(859899950148792148, "SampleSet", unwrapSetRequest)
	registry.Register(859879334305771348, "SampleGet", unwrapGetRequest)
	registry.Register(16129836997487988187, "SampleEchoTunnel", unwrapEchoRequest)
	registry.Register(8481593834425277560, "SampleEchoInternal", unwrapEchoRequest)
	registry.Register(5258191516040289195, "SampleEchoDelay", unwrapEchoRequest)
