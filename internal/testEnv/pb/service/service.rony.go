...
func unwrapGetResponse(e registry.Envelope) (proto.Message, error) {
	x := &GetResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapSetRequest(e registry.Envelope) (proto.Message, error) {
	x := &SetRequest{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapSetResponse(e registry.Envelope) (proto.Message, error) {
	x := &SetResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEchoRequest(e registry.Envelope) (proto.Message, error) {
	x := &EchoRequest{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEchoResponse(e registry.Envelope) (proto.Message, error) {
	x := &EchoResponse{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapMessage1(e registry.Envelope) (proto.Message, error) {
	x := &Message1{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapMessage2(e registry.Envelope) (proto.Message, error) {
	x := &Message2{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
