...
func unwrapEnvelope1(e registry.Envelope) (proto.Message, error) {
	x := &Envelope1{}
...
func unwrapEnvelope2(e registry.Envelope) (proto.Message, error) {
	x := &Envelope2{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEmbed1(e registry.Envelope) (proto.Message, error) {
	x := &Embed1{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEmbed2(e registry.Envelope) (proto.Message, error) {
	x := &Embed2{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
