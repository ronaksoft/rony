...
func (Model3P1IDShardKeyPK) makeItPrivate() {}
...
func (r *Model3LocalRepo) ListWithTxn(
	...
	case Model3P1IDShardKeyPK:
		opt.Prefix = alloc.Gen('M', C_Model3, 3043437686)
		seekKey = alloc.Gen('M', C_Model3, 3043437686, pk.P1, pk.ID, pk.ShardKey)
...
func (r *Model3RemoteRepo) MVP1IDShardKey() *table.Table {
...
func (r *Model3RemoteRepo) GetByP1IDShardKey(p1 []byte, id int64, shardKey int32, m *Model3) (*Model3, error) {
