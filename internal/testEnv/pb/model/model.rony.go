...
import (
	...
	querypool "github.com/ronaksoft/rony/pools/querypool"
...
func unwrapModel1(e registry.Envelope) (registry.Message, error) {
	x := &Model1{}
...
func unwrapModel2(e registry.Envelope) (registry.Message, error) {
	x := &Model2{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapModel3(e registry.Envelope) (registry.Message, error) {
	x := &Model3{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func NewModel1GlobalRepo(s gocqlx.Session) *Model1GlobalRepo {
	...
	r.qp = map[string]*querypool.QueryPool{
		...
		"getByCustomerSort": querypool.New(func() *gocqlx.Queryx {
...
func NewModel2GlobalRepo(s gocqlx.Session) *Model2GlobalRepo {
	...
	r.qp = map[string]*querypool.QueryPool{
		...
		"getByP1ShardKeyID": querypool.New(func() *gocqlx.Queryx {
...
func NewModel3GlobalRepo(s gocqlx.Session) *Model3GlobalRepo {
	...
	r.qp = map[string]*querypool.QueryPool{
		...
		"getByP1IDShardKey": querypool.New(func() *gocqlx.Queryx {
