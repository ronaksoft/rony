...
func (r *Model1LocalRepo) ListWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model1PartKey, lo *store.ListOption, cond func(m *Model1) bool,
) ([]*Model1, error) {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
	...
	case Model1PK:
		...
		seekKey = alloc.Gen('M', C_Model1, 1248998560, pk.ID)

	case Model1CustomerSortPK:
		opt.Prefix = alloc.Gen('M', C_Model1, 2535881670)
		seekKey = alloc.Gen('M', C_Model1, 2535881670, pk.Enum)
...
func (r *Model1LocalRepo) List(
	pk Model1PartKey, lo *store.ListOption, cond func(m *Model1) bool,
) ([]*Model1, error) {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model1LocalRepo) IterWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model1PartKey, ito *store.IterOption, cb func(m *Model1) bool,
) error {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
...
func (r *Model1LocalRepo) Iter(
	pk Model1PartKey, ito *store.IterOption, cb func(m *Model1) bool,
) error {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model2LocalRepo) ListWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model2PartKey, lo *store.ListOption, cond func(m *Model2) bool,
) ([]*Model2, error) {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
	...
	case Model2PK:
		...
		seekKey = alloc.Gen('M', C_Model2, 1609271041, pk.ID, pk.ShardKey)

	case Model2P1ShardKeyIDPK:
		opt.Prefix = alloc.Gen('M', C_Model2, 2344331025)
		seekKey = alloc.Gen('M', C_Model2, 2344331025, pk.P1)
...
func (r *Model2LocalRepo) List(
	pk Model2PartKey, lo *store.ListOption, cond func(m *Model2) bool,
) ([]*Model2, error) {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model2LocalRepo) IterWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model2PartKey, ito *store.IterOption, cb func(m *Model2) bool,
) error {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
...
func (r *Model2LocalRepo) Iter(
	pk Model2PartKey, ito *store.IterOption, cb func(m *Model2) bool,
) error {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model3LocalRepo) ListWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model3PartKey, lo *store.ListOption, cond func(m *Model3) bool,
) ([]*Model3, error) {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
	...
	case Model3PK:
		...
		seekKey = alloc.Gen('M', C_Model3, 1609271041, pk.ID, pk.ShardKey)

	case Model3P1ShardKeyIDPK:
		opt.Prefix = alloc.Gen('M', C_Model3, 2344331025)
		seekKey = alloc.Gen('M', C_Model3, 2344331025, pk.P1)

	case Model3P1IDPK:
		opt.Prefix = alloc.Gen('M', C_Model3, 3623577939)
		seekKey = alloc.Gen('M', C_Model3, 3623577939, pk.P1)
...
func (r *Model3LocalRepo) List(
	pk Model3PartKey, lo *store.ListOption, cond func(m *Model3) bool,
) ([]*Model3, error) {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model3LocalRepo) IterWithTxn(
	txn *rony.StoreTxn, alloc *tools.Allocator, pk Model3PartKey, ito *store.IterOption, cb func(m *Model3) bool,
) error {
	if alloc == nil {
		alloc = tools.NewAllocator()
		defer alloc.ReleaseAll()
...
func (r *Model3LocalRepo) Iter(
	pk Model3PartKey, ito *store.IterOption, cb func(m *Model3) bool,
) error {
	alloc := tools.NewAllocator()
	defer alloc.ReleaseAll()
...
func (r *Model1RemoteRepo) List(pk Model1PartKey, limit uint) ([]*Model1, error) {
	var (
		q   *gocqlx.Queryx
		res []*Model1
		err error
...
func (r *Model2RemoteRepo) List(pk Model2PartKey, limit uint) ([]*Model2, error) {
	var (
		q   *gocqlx.Queryx
		res []*Model2
		err error
...
func (r *Model3RemoteRepo) List(pk Model3PartKey, limit uint) ([]*Model3, error) {
	var (
		q   *gocqlx.Queryx
		res []*Model3
		err error
