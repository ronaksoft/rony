...
func (g *Generator) Generate(file *generator.FileDescriptor) {
	...
	for _, s := range file.Service {
		...
		g.g.P()
		genServerInterface(g, s)
		g.g.P()
		genServerWrapper(g, s)
		g.g.P()
		genClient(g, s)
		g.g.P()
	}
...
func genServerInterface(g *Generator, s *descriptor.ServiceDescriptorProto) {
...
func genServerWrapper(g *Generator, s *descriptor.ServiceDescriptorProto) {
...
func genClient(g *Generator, s *descriptor.ServiceDescriptorProto) {
