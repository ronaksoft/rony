...
func unwrapMessageEnvelope(e registry.Envelope) (registry.Message, error) {
	x := &MessageEnvelope{}
...
func unwrapPing(e registry.Envelope) (registry.Message, error) {
	x := &Ping{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapPong(e registry.Envelope) (registry.Message, error) {
	x := &Pong{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapKeyValue(e registry.Envelope) (registry.Message, error) {
	x := &KeyValue{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapMessageContainer(e registry.Envelope) (registry.Message, error) {
	x := &MessageContainer{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapError(e registry.Envelope) (registry.Message, error) {
	x := &Error{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapRedirect(e registry.Envelope) (registry.Message, error) {
	x := &Redirect{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEdge(e registry.Envelope) (registry.Message, error) {
	x := &Edge{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapEdges(e registry.Envelope) (registry.Message, error) {
	x := &Edges{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapGetNodes(e registry.Envelope) (registry.Message, error) {
	x := &GetNodes{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapGetAllNodes(e registry.Envelope) (registry.Message, error) {
	x := &GetAllNodes{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
...
func unwrapHttpBody(e registry.Envelope) (registry.Message, error) {
	x := &HttpBody{}
	err := x.Unmarshal(e.GetMessage())
	if err != nil {
		return nil, err
